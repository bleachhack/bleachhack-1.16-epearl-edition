	...
	public UI() {
		super("UI", KEY_UNBOUND, ModuleCategory.RENDER, true, "Shows stuff onscreen.",
				new SettingToggle("Modulelist", true).withDesc("Shows the module list").withChildren( // 0
						...
						new SettingToggle("Watermark/Welcomer", true).withDesc("Adds the BleachHack watermark to the module list").withChildren( // 0-3
	...
	private List<Text> getModuleListText() {
		...
		for (Module m : ModuleManager.getModules())
			...
			/*	MutableText text1 = new LiteralText("> Bleach").styled(s -> s.withColor(TextColor.fromRgb(0x4f82f0)));
				MutableText text2 = new LiteralText("Hack " + BleachHack.VERSION).styled(s -> s.withColor(TextColor.fromRgb(0x345aad)));
             */
				MutableText text1 = new LiteralText("Bleach").styled(s -> s.withColor(TextColor.fromRgb(0x4f82f0)));
